  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "step-2",
        type: "observe",
        expectedCommands: ["ipmitool chassis power status"],
        hasQuiz: false,
      },
      {
        id: "step-3",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "scontrol update nodename=dgx-00 state=drain reason='GPU memory cleanup'",
        ],
        hasQuiz: false,
      },
      {
      ...
      },
      {
        id: "step-11",
        type: "command",
        expectedCommands: ["scontrol update nodename=dgx-00 state=resume"],
        hasQuiz: false,
      },
    ],
  },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "step-7",
        type: "command",
        expectedCommands: ["mlxconfig -d /dev/mst/mt4129_pciconf0 q"],
        hasQuiz: false,
      },
      {
        id: "step-8",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "step-3",
        type: "command",
        expectedCommands: ["export NCCL_DEBUG=INFO"],
        hasQuiz: false,
      },
      {
        id: "step-4",
        type: "command",
        expectedCommands: ["export NCCL_IB_DISABLE=0"],
        hasQuiz: true,
        quizCorrectIndex: 1,
      },
      {
        id: "step-5",
        type: "command",
        expectedCommands: ["export NCCL_P2P_DISABLE=0"],
        hasQuiz: false,
      },
      {
        id: "step-6",
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "mpirun -np 64 -H dgx-00,dgx-01,dgx-02,dgx-03,dgx-04,dgx-05,dgx-06,dgx-07 all_reduce_perf",
        ],
        hasQuiz: false,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          'sbatch --gres=gpu:1 --wrap="nvidia-smi -L"',
          "sbatch",
        ],
        hasQuiz: false,
      },
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "sacct -j 1 --format=JobID,State,AllocTRES",
          "sacct",
        ],
        hasQuiz: false,
      },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "enroot create --name pytorch pytorch.sqsh",
          "enroot create",
        ],
        hasQuiz: false,
      },
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "srun --gres=gpu:8 --container-image=nvcr.io#nvidia/pytorch:24.01-py3 nvidia-smi -L",
        ],
        hasQuiz: false,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "mpirun -np 64 all_reduce_perf -b 8 -e 1G -f 2 -g 1",
          "mpirun",
        ],
        hasQuiz: true,
        quizCorrectIndex: 1,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "command",
        expectedCommands: [
          "dcgmi policy --set --condition ecc --action log",
          "dcgmi policy --get",
        ],
        hasQuiz: false,
      },
